...
CREATE TABLE project_risks (
    ...
    project_id UUID REFERENCES aisse_projects(id) ON DELETE CASCADE,
...
CREATE INDEX idx_aisse_projects_health_status ON aisse_projects(health_status);
CREATE INDEX idx_aisse_projects_current_stage ON aisse_projects(current_stage);
CREATE INDEX idx_aisse_projects_approach_number ON aisse_projects(approach_number);
CREATE INDEX idx_aisse_projects_threshold_option ON aisse_projects(threshold_option);
CREATE INDEX idx_aisse_projects_repository_url ON aisse_projects(repository_url);
